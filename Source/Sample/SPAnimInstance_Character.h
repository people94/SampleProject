...
#include "SPAnimInstance_Character.generated.h"

/**
 * 
 */
UCLASS()
class SAMPLE_API USPAnimInstance_Character : public UAnimInstance
{
	GENERATED_BODY()

public:
	USPAnimInstance_Character();
...
private:
	class ASPCharacter_Player* OwnerPawn;
