...
USPAnimInstance_Character::USPAnimInstance_Character()
{
}

void USPAnimInstance_Character::NativeInitializeAnimation()
{
	OwnerPawn = Cast<ASPCharacter_Player>(TryGetPawnOwner());
	if (OwnerPawn)
	{
...
void USPAnimInstance_Character::NativeUpdateAnimation(float DeltaSeconds)
{
	if (OwnerPawn)
	{
...
void USPAnimInstance_Character::TurnInPlace()
{
	if (OwnerPawn)
	{
...
void USPAnimInstance_Character::TurnInPlace1()
{
...
// 내가 이해한대로 만든 것
void USPAnimInstance_Character::TurnInPlace2()
{
